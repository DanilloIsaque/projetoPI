...
<div class="container">
  <div class="row">
    <div class="col">
      <h1>Cadastro de Produto</h1>
        <form action="acessoProduto.php" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="preco" name="preco" step=".01" min="1" max="99999.99"  onkeypress="return semLetra(event)" aria-describedby="emailHelp" placeholder="Digite o preço" required>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id= "desconto"" name="desconto" step="0.01" min="1" onkeypress="return semLetra(event)" aria-describedby="emailHelp" placeholder="Digite o desconto" required>
  </div>
