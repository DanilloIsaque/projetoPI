...
<div class="container">
   <div class="row">
    ...
    <form action="acessoImg.php" method="POST" enctype="multipart/form-data">

  <div class="form-group">
    <label for="exampleInputEmail1">Ordem da Imagem</label>
    <input type="number" class="form-control" name="imagemOrdem" min="1" placeholder="Digite a ordem da imagem" required>
  </div>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Selecione a imagem</label>
    <input type="file" class="form-control" name="imagem" required>
  </div>
</div>
</div>

<button type="submit" class="btn btn-primary" role="button" value="enviar">Cadastrar</button> <a class="btn btn-primary" href="listarImg.php" role="button">Consultar</a>
</form>
    </div>
   </div>
    </div>
