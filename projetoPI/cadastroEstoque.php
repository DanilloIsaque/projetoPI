...
<div class="container">
  ...
  <input type="text" class="form-control" maxlength=10 name="qtdEstoque" min="0" onkeypress="return semLetra(event)" aria-describedby="emailHelp" placeholder="Digite a quantidade"  required>
